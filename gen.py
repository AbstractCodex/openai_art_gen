...
PROMPT = "Please follow these instructions exactly, with no prompt rewriting. A poleaxe against a solid orange background. The poleaxe is a long weapon consisting of a wooden pole with a large steel hammer head attached to teh pole with flat steel brackets. Whiel the poleaxe has a hammer on one side of teh head, it has an axe blade on teh other side. Also, there is a long spike on the top of the poleaxe, like a spear. The viewpoint is far, with a view of the entire poleaxe. Use a photorealistic style."
